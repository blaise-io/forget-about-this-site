...
module.exports = JSON.stringify({
    ...
    extensionDescription: { message: `页面操作按钮,用于删除您正在访问的网站的cookie,本地存储,浏览历史记录和下载历史记录。` },
    ...
    localStorage: { message: `本地存储` },
    history: { message: `浏览历史记录` },
    downloads: { message: `下载历史记录` },
    beforeDeleting: { message: `在删除项目之前:` },

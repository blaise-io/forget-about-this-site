...
module.exports = JSON.stringify({
    ...
    downloads: { message: `Download Verlauf` },
    beforeDeleting: { message: `Vor dem Löschen von Elementen:` },
    closeTab: { message: `Tab schließen` },
    closeTabHelp: { message: `Dies verhindert, dass die Website nach dem Löschen zusätzliche Elemente schreibt` },
    ...
    lastSaved: { message: `Zuletzt gespeichert:` },
}, null, 2);
